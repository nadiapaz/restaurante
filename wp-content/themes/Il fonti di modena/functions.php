...
wp_register_style('booststrap-datepicker.css', get_theme_file_uri('/assets/vendor/css/booststrap-datepicker.css'), null, $theme_data->get('Version'), 'screen');
wp_register_style('flexslider.css', get_theme_file_uri('/assets/vendor/css/flexslider.css'), null, $theme_data->get('Version'), 'screen');
wp_register_style('magnific-popup.css', get_theme_file_uri('/assets/vendor/css/magnific-popup.css'), null, $theme_data->get('Version'), 'screen');
wp_register_style('owl.carousel.min.css', get_theme_file_uri('/assets/vendor/css/owl.carousel.min.css'), null, $theme_data->get('Version'), 'screen');
wp_register_style('owl.theme.default.min.css', get_theme_file_uri('/assets/vendor/css/owl.theme.default.min.css'), null, $theme_data->get('Version'), 'screen');
wp_register_style('style.css.map.css', get_theme_file_uri('/assets/vendor/css/style.css.map.css'), null, $theme_data->get('Version'), 'screen');
